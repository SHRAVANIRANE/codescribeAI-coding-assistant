  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex mb-3">
        ...
        >
          <span
            className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-600 via-purple-600 to-pink-700"
          />
      ...
      {repoError &&
        <p
          className="text-red-400 bg-red-900/30 border border-red-700 px-4 py-2 rounded-lg text-sm mt-2"
        >
          {repoError}
        </p>}
